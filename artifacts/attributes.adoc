...
:diagnostic-data-collection-book-link: {product-docs-link}/html-single/collect_diagnostic_data_for_support_cases/index
:diagnostic-data-collection-book-title: Collect diagnostic data for support cases
