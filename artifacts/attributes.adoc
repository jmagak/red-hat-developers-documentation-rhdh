...
:rhoserverless-logic-brand-name: Red Hat OpenShift Serverless Logic
...
:diagnostic-data-collection-book-link: {product-docs-link}/html-single/collecting_diagnostic_data_for_red_hat_developer_hub/index
:diagnostic-data-collection-book-title: Collecting diagnostic data for {product}
...
:installing-on-aks-book-title: Installing {product} on {aks-brand-name} ({aks-short})
...
:installing-on-eks-book-title: Installing {product} on {eks-brand-name} ({eks-short})
...
:installing-on-gke-book-title: Installing {product} on {gke-brand-name} ({gke-short})
...
:installing-on-osd-on-gcp-book-title: Installing {product} on {osd-short} on {gcp-brand-name}
:integrating-with-github-book-link: {product-docs-link}/html-single/integrating_red_hat_developer_hub_with_your_git_provider/index
:integrating-with-github-book-title: Integrating {product} with your Git provider
:integrating-with-your-git-provider-book-link: {product-docs-link}/html-single/integrating_red_hat_developer_hub_with_your_git_provider/index
:integrating-with-your-git-provider-book-title: Integrating {product} with your Git provider
...
:manage-and-consume-techdocs-book-link: {product-docs-link}/html-single/manage_and_consume_technical_documentation_within_red_hat_developer_hub/index
:manage-and-consume-techdocs-book-title: Manage and consume technical documentation within {product}
:model-context-protocol-book-link: {product-docs-link}/html-single/interacting_with_model_context_protocol_tools_for_red_hat_developer_hub/index
:model-context-protocol-book-title: Interacting with Model Context Protocol tools for {product}
...
:navigate-rhdh-on-your-first-day-book-link: {product-docs-link}/html-single/navigate_red_hat_developer_hub_on_your_first_day/index
:navigate-rhdh-on-your-first-day-book-title: Navigate {product} on your first day
...
:openshift-ai-connector-for-rhdh-book-link: {product-docs-link}/html-single/accelerate_ai_development_with_openshift_ai_connector_for_red_hat_developer_hub/index
:openshift-ai-connector-for-rhdh-book-title: Accelerate AI development with {openshift-ai-connector-name}
...
:setting-up-and-configuring-book-link: {product-docs-link}/html-single/setting_up_and_configuring_your_first_red_hat_developer_hub_instance/index
:setting-up-and-configuring-book-title: Setting up and configuring your first {product} instance
:streamline-software-development-and-management-in-rhdh-book-link: {product-docs-link}/html-single/streamline_software_development_and_management_in_red_hat_developer_hub/index
:streamline-software-development-and-management-in-rhdh-book-title: Streamline software development and management in {product}
...
:telemetry-data-collection-book-title: Telemetry data collection and analysis
