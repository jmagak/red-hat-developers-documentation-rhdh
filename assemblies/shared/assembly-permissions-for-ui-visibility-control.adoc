...
include::../../modules/shared/ref-ui-elements-with-visibility-control.adoc[leveloffset=+1]

include::../../modules/shared/ref-permission-evaluation-behavior.adoc[leveloffset=+1]
