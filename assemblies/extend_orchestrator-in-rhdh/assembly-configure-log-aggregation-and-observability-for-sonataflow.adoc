...
include::../modules/extend_orchestrator-in-rhdh/proc-aggregate-logs-using-the-promtail-loki-and-grafana-plg-stack.adoc[leveloffset=+1]

// Alerts for workflow health
include::../modules/extend_orchestrator-in-rhdh/proc-configure-alerts-for-workflow-conditions.adoc[leveloffset=+1]
...
include::../modules/extend_orchestrator-in-rhdh/proc-troubleshoot-observability-and-log-aggregation-in-sonataflow.adoc[leveloffset=+1]
