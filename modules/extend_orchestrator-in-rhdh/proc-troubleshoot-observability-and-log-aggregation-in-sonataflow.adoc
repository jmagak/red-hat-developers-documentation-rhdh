...
[id="troubleshoot-observability-and-log-aggregation-in-sonataflow_{context}"]
= Troubleshoot observability and log aggregation in SonataFlow

[role="_abstract"]
Diagnose and resolve common issues with JSON logging, process context correlation, and log collection in a SonataFlow environment.
